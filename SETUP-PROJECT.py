...
<Project ToolsVersion="Current" xmlns="http://schemas.microsoft.com/developer/msbuild/2003">
   ...
   <Target Name="CopyToTestProfile" DependsOnTargets="NetcodePatch" AfterTargets="PostBuildEvent">
      ...
      <Exec Command="{copyCommand} &quot;../UnityProject/AssetBundles/StandaloneWindows/toiletleech&quot; &quot;$(TestProfileDir)BepInEx/plugins/$(AssemblyName)-DEV/&quot;" />
      <Exec Command="echo '[csproj.user] Mod files copied to $(TestProfileDir)BepInEx/plugins/$(AssemblyName)-DEV/'" />
   </Target>
</Project>"""

fp = open(f'{thisPath}/Plugin/ToiletLeechIsReal.csproj.user', 'w')
fp.write(userFile)
fp.close()
print(color.green + f'csproj.user file created at {thisPath}/Plugin/ToiletLeechIsReal.csproj.user!')
